<template lang="pug">
  #range
    div(v-if="value.length != 0")
      v-range-slider.py-12.my-12(thumb-label="always", color="blue", v-model="val", step="10", style="width: 100%;", :min="getMin()", :max="getMax()")
      v-btn(block, color="blue", dark, rounded, :disabled="value.length == 0", @click="selectOption()") Siguiente
    div(v-else)
